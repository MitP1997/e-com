...
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form>
          ...
          <button id="PayButton" class="btn btn-block btn-success submit-button" type="button" onclick="window.location.href='done.php'">
              <span class="submit-button-lock"></span>
              <span class="align-middle" >Pay <?php echo "INR ".$_SESSION['amount']; ?></span>
          </button>
      </form>
  </div>
</div>

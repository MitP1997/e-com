...
<head>
    ...
    <title>Eyeglasses-Eye See You</title>
...
<body>
  ...
  <div class="container">
        ...
        <?php
            $result = mysql_query("SELECT * FROM products where gender = 'W' and category = 'E'") or die(mysql_error());
...
<!-- 			<div class="col-sm-4 text-center">
  ...
  <div class="button"><a href="#">AddToCart</a></div>
			...
			<div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/XXweg6.jpg" alt="">
...
<div class="container">
        <div class="row">
            <div class="box">
                ...
                <?php
            $result = mysql_query("SELECT * FROM products where gender = 'M' and category = 'E'") or die(mysql_error());
            if (mysql_num_rows($result) > 0) 
            { 
                while ($row = mysql_fetch_array($result)) 
                {
        ?>
                <div class="col-sm-4 text-center" height="400px">
                    
                    <a href="ImgOpen.html"><img height = "100px" class="img-responsive" src="<?php echo $row['img']; ?>" alt="Image1">
     <p class="title"><?php echo "Rs. ".$row['price']; ?></p>
  <div class="overlay"></div></a>
    ...
    ?>    
    <div class="button">
        <a href="<?php echo $url.'eyeglasses.php?atc='.$row['product_id']; ?> ">AddToCart</a>
